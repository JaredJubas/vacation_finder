    ...
    <div className="App">
      <header className="App-header">
        <div className="container">
          ...
          <input type="text" id="mintemp" name="mintemp" placeholder='Mintemp' value={minTemp} onChange={handleMinTemp}></input><br />
          <label for="maxtemp">Maximum Temperature: </label>
          <input type="text" id="maxtemp" name="maxtemp" placeholder='MaxTemp' value={maxTemp} onChange={handleMaxTemp}></input><br />
